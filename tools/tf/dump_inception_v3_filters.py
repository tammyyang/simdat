'''
This is a simple script to convert inception v3 weights
from tensorflow checkpoint files to hdf5.

Original source from https://github.com/Moodstocks/inception-v3.torch
'''
import os.path
import re
import sys
...
tf.app.flags.DEFINE_string(
    'model_dir', '/home/shared/model_zoo/inception-v3/',
